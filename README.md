...
- **Data & ML Engineer**: Model development and MLflow
- **MLOps/CI Engineer**: Docker and CI/CD setup
- **API Developer**: FastAPI development
- **Monitoring Engineer**: Prometheus and Grafana
